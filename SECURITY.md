...
The `1.0.0` line is the current supported stable line. Earlier `1.0.0-rc.*` and `0.1.0-alpha.*` snapshots are historical development artifacts and are not maintained as separate security-support branches.
