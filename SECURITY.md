...
The `1.0.0-rc.1` line is the current release candidate. Earlier `0.1.0-alpha.*` snapshots are historical development artifacts and are not maintained as separate security-support branches.
